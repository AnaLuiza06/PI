...
<body>
	...
	<section class="imguser">
		<div class="txt-imguser">
			...
			<button><a href="../formsAdd/addexercicio.php">Adicionar Alongamento</a></button>
		</div>
		</div>
			...
			<div class="card-tabela">
				<section>
					...
					<div class="btns-card-tabela">
						...
						<button><a href="../../conexao/delete/delexercicio.php?cd=<?php echo $exibe[$i]['id_exercicio'];?>">Deletar</a></button>
					</div>
				</section>
			</div>
			<?php
