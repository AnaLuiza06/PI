...
INSERT INTO
  `videosDesafio`(`id_desafio`, `id_video`)
VALUES
  (1, 1),
  (1, 2);
...
VALUES
  (
    ...
    'vermelho',
    'gordo',
    '<iframe width="560" height="315" src="https://www.youtube.com/embed/OGJvhpoE8b4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
    'https://i.pinimg.com/736x/db/21/36/db2136077e65ceb776414923880ff726.jpg'
  ),
  (
    'Teste 2',
...
INSERT INTO
  `autoavaliacao` (
    `id_exercicio`,
    `id_usuario`,
    `rendimento_autoavaliacao`,
    `cansasso_autoavaliacao`,
    `dor_autoavaliacao`,
    `dornopeito_autoavaliacao`
  )
VALUES
  (1, 1, 'Bom', 'Não', 'Não', 'Não');
...
INSERT INTO
  `favoritos`(`id_usuario`, `id_exercicio`)
VALUES
  (1, 1),
  (1, 2);
